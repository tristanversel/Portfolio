...
let projetsection = document.getElementById('projetsection');
let contactsection = document.getElementById('contactsection');

const projets = document.getElementsByClassName('projet');
const projetslink = document.getElementsByClassName('projetlink');
const icongit = document.getElementsByClassName('icongit');
const icondemo = document.getElementsByClassName('icondemo');
...
btndark.addEventListener('click', function(){
    if(dark){
        ...
        block2.style.backgroundColor = "rgb(240,240,240)";
        ...
        projetsection.style.backgroundColor = "rgb(247, 247, 247)";
        projetsection.style.color = 'black';
        for(i=0;i<projets.length;i++){
            projets[i].style.backgroundColor = 'white';
        }
        for(i=0;i<projetslink.length;i++){
            projetslink[i].style.color = 'black';
        }
        for(i=0;i<icongit.length;i++){
            icongit[i].src = 'images/git.png';
        }
        for(i=0;i<icondemo.length;i++){
            icondemo[i].src = 'images/left-click.png';
        }
        contactsection.style.backgroundColor='rgb(240, 240, 240)';
        contacts[0].style.boxShadow = '-5px 0px 15px 5px rgba(110, 110, 110, 0.2)';
        contacts[1].style.boxShadow = '5px 0px 15px 5px rgba(110, 110, 110, 0.2)';
        contacts[1].style.background = 'url(images/contact.jpg)';
        contacts[1].style.backgroundSize = 'cover';
        dark = false;
    }else{
        ...
        for(i=0; i<itemcard.length; i++){
            itemcard[i].style.boxShadow= "none";
            itemcard[i].style.backgroundColor = "rgb(40,40,40)";
            itemcard[i].style.color = "white";
        }
        block2.style.backgroundColor = "rgb(25,25,25)";
        ...
        projetsection.style.backgroundColor = "rgb(25,25,25)";
        projetsection.style.color = 'white';
        for(i=0;i<projets.length;i++){
            projets[i].style.backgroundColor = 'rgb(40,40,40)';
        }
        for(i=0;i<projetslink.length;i++){
            projetslink[i].style.color = 'white';
        }
        for(i=0;i<icongit.length;i++){
            icongit[i].src = 'images/github.png';
        }
        for(i=0;i<icondemo.length;i++){
            icondemo[i].src = 'images/left-click-white.png';
        }
        contactsection.style.backgroundColor='rgb(30, 30, 30)';
        contacts[0].style.boxShadow = 'none';
        contacts[1].style.boxShadow = 'none';
        contacts[1].style.background = 'url(images/contact-black.jpg)';
        contacts[1].style.backgroundSize = 'cover';
        dark = true;
    }
});
